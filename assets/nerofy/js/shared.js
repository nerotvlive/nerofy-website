...
function addFooter() {
    if(!document.getElementById("menu")) {
        const content = document.querySelector(".content");
        let footer = "<div class='container-fluid bg-black p-3 py-5 w-100 d-flex justify-content-center align-items-center text-center'><p class='m-0 p-0 opacity-75'><a class='link' href='https://nerofy.de/old/rechtliches' target='_blank'>Imprint and Privacy Declaration (ger)</a><br>©copyright 2026 Nerofy Network. All rights reserved.</p></div>";
